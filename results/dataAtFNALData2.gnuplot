...
set output 'dataAtFNALData2.png'
set lmargin 25
set rmargin 10
set tmargin 6
set bmargin 8
...
'dataAtFNALData.txt' using 1:($16) with linespoints ls 6 title 'Purdue', \
'dataAtFNALData.txt' using 1:($15) with linespoints ls 5 title 'Florida', \
'dataAtFNALData.txt' using 1:($14) with linespoints ls 1 title 'MIT', \
'dataAtFNALData.txt' using 1:($13) with linespoints ls 2 title 'Nebraska', \
'dataAtFNALData.txt' using 1:($12) with linespoints ls 3 title 'UCSD', \
'dataAtFNALData.txt' using 1:11 with linespoints ls 4 title 'Caltech'
