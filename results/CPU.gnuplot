...
plot \
'todayCPU.txt' using 1:2 with lines ls 3 title 'Queued (preplaced)', \
'todayCPU.txt' using 1:3 with lines ls 2 title 'Running (preplaced)', \
'todayCPU.txt' using 1:4 with lines ls 1 title 'Done (preplaced)', \
'serialCPU.txt' using 1:2 with lines ls 6 title 'Queued (copied)', \
'serialCPU.txt' using 1:3 with lines ls 5 title 'Running (copied)', \
'serialCPU.txt' using 1:4 with lines ls 4 title 'Done (copied)', \
'dataAtFNALCPU.txt' using 1:2 with lines ls 9 title 'Queued (remote)', \
'dataAtFNALCPU.txt' using 1:3 with lines ls 8 title 'Running (remote)', \
'dataAtFNALCPU.txt' using 1:4 with lines ls 7 title 'Done (remote)'
