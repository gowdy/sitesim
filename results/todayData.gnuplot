...
plot \
'todayData.txt' using 1:($11+$12+$13+$14+$15+$16+$17+$18) with filledcurves x1 ls 2 title 'Wisconsin', \
'todayData.txt' using 1:($11+$12+$13+$14+$15+$16+$17) with filledcurves x1 ls 3 title 'Vanderbilt', \
'todayData.txt' using 1:($11+$12+$13+$14+$15+$16) with filledcurves x1 ls 4 title 'Purdue', \
