...
plot \
'dataAtFNALCPU.txt' using 1:2 with linespoints ls 4 title 'Queued', \
'dataAtFNALCPU.txt' using 1:3 with linespoints ls 3 title 'Running', \
'dataAtFNALCPU.txt' using 1:4 with linespoints ls 2 title 'Done'
