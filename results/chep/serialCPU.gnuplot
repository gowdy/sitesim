...
set output 'serialCPU.png'
set lmargin 25
set rmargin 10
set tmargin 6
set bmargin 8
set title "Job States when data transferred"
set title font "*,24"
set xlabel "hours"
set xlabel font "*,24"
...
plot \
'serialCPU.txt' using 1:2 with linespoints ls 4 title 'Queued', \
'serialCPU.txt' using 1:3 with linespoints ls 3 title 'Running', \
'serialCPU.txt' using 1:4 with linespoints ls 2 title 'Done'
