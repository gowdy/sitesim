...
set output 'serialCPUSite.png'
set lmargin 25
set rmargin 10
set tmargin 6
set bmargin 8
set title "Job running at sites with data transferred"
set title font "*,24"
set xlabel "hours"
set xlabel font "*,24"
...
plot \
'serialCPUSite.txt' using 1:($11+$12+$13+$14+$15+$16+$17+$18+$19) with filledcurves x1 ls 9 title 'FNAL', \
'serialCPUSite.txt' using 1:($11+$12+$13+$14+$15+$16+$17+$18) with filledcurves x1 ls 8 title 'MIT', \
'serialCPUSite.txt' using 1:($11+$12+$13+$14+$15+$16+$17) with filledcurves x1 ls 7 title 'UCSD', \
'serialCPUSite.txt' using 1:($11+$12+$13+$14+$15+$16) with filledcurves x1 ls 6 title 'Nebraska', \
'serialCPUSite.txt' using 1:($11+$12+$13+$14+$15) with filledcurves x1 ls 5 title 'Caltech', \
'serialCPUSite.txt' using 1:($11+$12+$13+$14) with filledcurves x1 ls 1 title 'Florida', \
'serialCPUSite.txt' using 1:($11+$12+$13) with filledcurves x1 ls 2 title 'Caltech', \
'serialCPUSite.txt' using 1:($11+$12) with filledcurves x1 ls 3 title 'Vanderbilt', \
'serialCPUSite.txt' using 1:11 with filledcurves x1 ls 4 title 'Purdue'
