...
plot \
'dataAtFNALData.txt' using 1:($11+$12+$13+$14+$15+$16+$17+$18) with filledcurves x1 ls 8 title 'Wisconsin', \
'dataAtFNALData.txt' using 1:($11+$12+$13+$14+$15+$16+$17) with filledcurves x1 ls 7 title 'Vanderbilt', \
'dataAtFNALData.txt' using 1:($11+$12+$13+$14+$15+$16) with filledcurves x1 ls 6 title 'Purdue', \
